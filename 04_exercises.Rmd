...
ggmap(twincities) + # creates the map "background"
  geom_point(data = Starbucks, 
             ...
             alpha = 1, 
             size = 2) +
  labs(title = "Starbucks near Macalester") +
  theme_map()
```
...
starbucks_with_2018_pop_est %>% 
  ...
  theme_map() +
  labs(fill = "Number of Starbucks per 10,000 people", 
...
favorite_by_anna <- tibble(
  place = c("Kimchi Tofu House", "Tono Pizzeria + Cheesesteak", 
            "Macalester College", "Science Museum of Minnesota", "Target Field", "Saint Paul Home",
            "Riverside Park", "NYC Home", "Jin Fong Restaurant", "The High Line", "Citi Field", "Kate's Seafood", 
            "Long Nook Beach"), 
  long = c( -93.22693673444148, -93.16733278846144, 
           -93.16905451640325, -93.09913377060474,   
           -93.27759701544593, -93.15993888846154,
           -73.9729219893889, -73.9717327732488, -73.97883524441367,  -74.0039163349285, -73.84583203092146, -70.11022135787704,
           -70.03705415706891), 
  lat = c(44.97333972848076, 44.934273777055594, 
          44.93861924693568, 44.946322266714894,  
          44.9818947558888, 44.93189077914104, 
          40.801862889204585, 40.79972265717478, 40.78301103574647, 40.751173188177894, 40.75725834451115, 41.75483506515295, 
          42.02195492958253), 
  top3 = c("no", "no", "yes", "no", "no", "no", "yes", "yes", "no", "no", "no", "no", "no")
)

# favorite_by_anna <- tibble(
#   place = c("Saint Paul Home", "Kimchi Tofu House", "Tono Pizzeria + Cheesesteak", 
#             "Macalester College", "Science Museum of Minnesota", "NYC Home", 
#             "Citi Field", "Target Field", "The High Line", 
#             "Riverside Park", "Jin Fong Restaurant", "Kate's Seafood", 
#             "Long Nook Beach"), 
#   long = c(-93.15993888846154, -93.22693673444148, -93.16733278846144, 
#            -93.16905451640325, -93.09913377060474,  -73.9717327732488, 
#            -73.84583203092146, -93.27759701544593, -74.0039163349285, 
#            -73.9729219893889, -73.97883524441367, -70.11022135787704,
#            -70.03705415706891), 
#   lat = c(44.93189077914104, 44.97333972848076, 44.934273777055594, 
#           44.93861924693568, 44.946322266714894, 40.79972265717478, 
#           40.75725834451115, 44.9818947558888, 40.751173188177894, 
#           40.801862889204585, 40.78301103574647, 41.75483506515295, 
#           42.02195492958253), 
#   top3 = c("", "", "", "", "", "Top 3", "", "", "", "Top 3", "", "", "Top 3")
# )
...
```{r}
factpal <- colorFactor(topo.colors(5), favorite_by_anna$top3)
...
stationTrips <- Trips %>%
  ...
  group_by(sstation) %>%
  mutate(count = n()) %>%
  #mutate(sum = count(sstation)) %>%
  left_join(Stations, 
            by = c("sstation" = "name")) 
stationTrips

pal <- colorNumeric("magma", 
                     domain = stationTrips$sstation) 

leaflet(stationTrips) %>%
  addProviderTiles(providers$Stamen.Terrain) %>%
  addCircles(lng = ~long, 
             lat = ~lat, 
             label = ~sstation, 
